...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String _token = "545de3082ead662dff516a498c92ee6c87f7742e";
  ...
  _search() async{
    ...
    http.Response response = await http.get(_url + _controller.text.trim(), headers: {"Authorization": "Token " + _token});
